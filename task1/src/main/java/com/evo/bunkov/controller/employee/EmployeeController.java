...
import com.evo.bunkov.action.CreateEmployeeAction;
import com.evo.bunkov.action.UpdateEmployeeAction;
...
import static com.evo.bunkov.controller.employee.mapper.EmployeeMapper.EMPLOYEE_MAPPER;
...
public class EmployeeController {
    ...
    public EmployeeDto update(@PathVariable UUID id,
        ...
        Employee updatedEmployee = updateEmployeeAction.execute(id, EMPLOYEE_MAPPER.updateDtoToArgument(employeeDto));
